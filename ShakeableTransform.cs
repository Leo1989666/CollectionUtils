...
public class ShakeableTransform : MonoBehaviour
{
    ...
    public void AssignData(Vector3 maximumTranslationShake, Vector3 maximumAngularShake, float frequency, float traumaExponent, float recoverySpeed)
    {
        this.maximumTranslationShake = maximumTranslationShake;
        this.maximumAngularShake = maximumAngularShake;
        this.frequency = frequency;
        this.traumaExponent = traumaExponent;
        this.recoverySpeed = recoverySpeed;
    }

    public void AssignLocalCenterPivotData(Vector3 originLocalPosition)
    {
        this._OriginLocalPosition = originLocalPosition;
    }
}